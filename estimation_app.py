...
DEMO_IMAGE = 'C:/Users/LENOVO/Downloads/stand.jpg'
...
net = cv2.dnn.readNetFromTensorflow(r"C:/Users/LENOVO/Downloads/graph_opt.pb")
...
st.image(
    image, caption=f"Original Image", use_container_width=True  # Updated here
) 
...
st.image(
    output, caption=f"Positions Estimated", use_container_width=True  # Updated here
)
